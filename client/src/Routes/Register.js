    ...
    render() {
        ...
        return (
            <div className="container">
                <div className="row">
                    <form onSubmit={this.onRegisterSubmit} className="col-11 col-md-9 offset-lg-2 col-lg-7">
                        ...
                        <div className="form-group text-nowrap">
                            ...
                            <div className="text-danger text-wrap">{this.state.nameHelper}</div>
                        ...
                        <div className="form-group text-nowrap">
                            ...
                            <div className="text-danger text-wrap">{this.state.surnameHelper}</div>
                        ...
                        <div className="form-group text-nowrap">
                            ...
                            <div className="text-danger text-wrap">{this.state.emailHelper}</div>
                        ...
                        <div className="form-group text-nowrap">
                            ...
                            <div className="text-danger text-wrap">{this.state.passwordHelper}</div>
                        ...
                        <div className="form-group text-nowrap">
                            ...
                            <div className="text-danger text-wrap">{this.state.compareHelper}</div>
                        ...
                        <div className="form-group">
                            <div className="text-danger text-wrap">{this.state.genderHelper}</div>
